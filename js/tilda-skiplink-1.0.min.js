function t_skiplink__addButton() {
  ...
  t &&
    (t.querySelector("#t-header") ||
      t.querySelector(".t-rec").querySelector('[data-menu="yes"]')) &&
    ((e =
      '<a href="#t-main-content" class="t-skiplink" aria-label="' +
  ...
  if ((t && t.insertAdjacentHTML("afterend", n), 0 < e.length && !t)) {
    ...
    if (1 === e.length) t.insertAdjacentHTML("afterend", n);
      ...
      for (var i = 0; i < e.length; i++) {
        ...
        if (null === r.nextElementSibling.querySelector('[data-menu="yes"]'))
