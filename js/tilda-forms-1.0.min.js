...
(window.t_forms__lang = (
  ...
  (window.tildaForm = {
    versionLib: "02.001",
    endpoint: "diongo.ru/api/marketing-info/",
    ...
    if (r || o || a) {
      ...
      if (!document.head.querySelector('script[src*="' + n + '"]'))
        ((i = document.createElement("script")).type = "text/javascript"),
          (i.src = "https://static.tildacdn.com/js/" + n + ".min.js"),
          (i.onerror = function () {
  ...
  (window.tildaForm_customMasksLoad = function () {
    if (!0 !== window.isInitEventsCustomMask) {
      ...
      (t.type = "text/javascript"),
        (t.src =
          "/js/zeroForms/tilda-forms-custommask-1.0.min.js"),
  ...
  (window.tildaForm.validate = function (t) {
    ...
    for (
      var e = t.querySelectorAll(".js-tilda-rule"), r = [], o = !0, a = 0;
      a < e.length;
      a++
    ) {
      var n = e[a],
        ...
        switch (s) {
          case "email":
            (l =
              ...
              p.length && !p.match(l) && m.type.push("email");
            break;
          case "url":
            (l =
              ...
              p.length &&
                ((d = (d =
                  (d = p.split("//")) && d.length > 1 ? d[1] : d[0]).split(
                  "/"
                )) &&
                d.length &&
                d[0]
                  ? (d = d[0]).match(l) || m.type.push("url")
                  : ((d && !d[0]) || m.type.push("url"), (d = "")));
            break;
          case "phone":
            ...
            b &&
              ...
              f.length && !f.match(l)
                ? m.type.push("phone")
                : (1 == (d = f.replace(/[^0-9]+/g, "")).indexOf("000") ||
                    (1 == d.indexOf("111") && "9" != d.substring(0, 1)) ||
                    (1 == d.indexOf("222") && "5" != d.substring(0, 1)) ||
                    1 == d.indexOf("333") ||
                    1 == d.indexOf("444") ||
                    (1 == d.indexOf("555") && "0" != d.substring(0, 1)) ||
                    (1 == d.indexOf("666") && "0" != d.substring(0, 1)) ||
                    (1 == d.indexOf("8888") && "4" != d.substring(0, 1))) &&
                  m.type.push("phone");
            break;
          case "number":
            (l = /^[0-9]+$/gi),
              f.length > 0 && !f.match(l) && m.type.push("number");
            break;
          case "date":
            var A = {
              "DD-MM-YYYY":
            ...
            f.length > 0 &&
              !f.match(
                A[n.getAttribute("data-tilda-dateformat")] ||
          ...
          case "time":
            (l = /^[0-9]{2}[:\.][0-9]{2}$/gi),
              f.length > 0 && !f.match(l) && m.type.push("time");
            break;
          case "name":
            (l =
              ...
              p.length && !p.match(l) && m.type.push("name");
            break;
          case "namecomp":
            (l =
              /^([0123456789ЁёäöüÄÖÜßèéûҐґЄєІіЇїӐӑЙйК̆к̆Ӄ̆ӄ̆Ԛ̆ԛ̆Г̆г̆Ҕ̆ҕ̆ӖӗѢ̆ѣ̆ӁӂꚄ̆ꚅ̆ҊҋО̆о̆Ө̆ө̆Ꚍ̆ꚍ̆ЎўХ̆х̆Џ̆џ̆Ꚏ̆ꚏ̆Ꚇ̆ꚇ̆Ҽ̆ҽ̆Ш̆ш̆Ꚗ̆ꚗ̆Щ̆щ̆Ы̆ы̆Э̆э̆Ю̆ю̆Я̆я̆А́а́ЃѓД́д́Е́е́Ё́ёӘ́ә́З́з́И́и́І́і́Ї́ї́ЌќЛ́л́Н́н́О́о́Р́р́С́с́Т́т́У́у́Ӱ́ӱ́Ү́ү́Х́х́Ц́ц́Ы́ы́Э́э́Ӭ́ӭ́Ю́ю́Ю̈́ю̈́Я́я́Ѣ́�
іҰұҮүӨөȺⱥꜺꜻƂƃɃƀȻȼꞒꞓƋƌĐđɆɇǤǥꞠꞡĦħƗɨƗ́ɨ́Ɨ̀ɨ̀Ɨ̂ɨ̂Ɨ̌ɨ̌Ɨ̃ɨ̃Ɨ̄ɨ̄Ɨ̈ɨ̈Ɨ̋ɨ̋Ɨ̏ɨ̏Ɨ̧ɨ̧Ɨ̧̀ɨ̧̀Ɨ̧̂ɨ̧̂Ɨ̧̌ɨ̧̌ᵼɈɉɟɟ̟ʄʄ̊ʄ̥K̵k̵ꝀꝁꝂꝃꝄꝅꞢꞣŁłł̓Ł̣ł̣ᴌȽƚⱠⱡꝈꝉƛƛ̓ꞤꞥꝊꝋØøǾǿØ̀ø̀Ø̂øØ̌ø̌Ø̄ø̄Ø̃ø̃Ø̨ø̨Ø᷎ø᷎ᴓⱣᵽꝐꝑꝖꝗꝘꝙɌɍꞦꞧꞨꞩẜẝŦŧȾⱦᵺꝤꝥꝦꝧɄʉɄ́ʉ́Ʉ̀ʉ̀Ʉ̂ʉ̂Ʉ̌ʉ̌Ʉ̄ʉ̄Ʉ̃ʉ̃Ʉ̃́ʉ̃́Ʉ̈ʉ̈ʉ̞ᵾU̸u̸ᵿꝞꝟw̸ɎɏƵƶA-Za-z\u00C0\u00C0-\u00C3\u00C8-\u00CA\u00CC\u00CD\u00D2-\u00D9\u00DA\u00DD\u00E0-\u00E3\u00E8\u00E9\u00EA\u00EC\u00ED\u00F2-\u00F5\u00F9\u00FA\u00FD\u0102\u0103\u0110\u0111\u0128\u0129\u0168\u0169\u01A0\u01A1\u01AF\u01B0\u1EA0\u1EA1-\u1EF9\u0041-\u007A\u00C0-\u02B8\u0300-\u03FF\u0400-\u04FF\u0500-\u05FF\u0600-\u06FF\u3040-\u30FF\uFB1D-\uFB1F\uFB2A-\uFB4E\u0E00-\u0E7F\u10A0-\u10FF\u3040-\u309F\u30A0-\u30FF\u2E80-\u2FD5\u3190-\u319f\u3400-\u4DBF\u4E00-\u9FCC\uF900-\uFAAD\-\'\‘\s\.]{0,})$/gi),
              p.length && !p.match(l) && m.type.push("name");
            break;
          case "nameeng":
            (l = /^([A-Za-z\s]{1,}((\-)?[A-Za-z\.\s](\')?){0,})*$/i),
              p.length && !p.match(l) && m.type.push("nameeng");
            break;
          case "namerus":
            (l = /^([А-Яа-яЁё\s]{1,}((\-)?[А-Яа-яЁё\.\s](\')?){0,})*$/i),
              p.length && !p.match(l) && m.type.push("namerus");
            break;
          case "string":
            (l =
              ...
              p.length && !p.match(l) && m.type.push("string");
            break;
          case "chosevalue":
            var F;
            "true" === n.getAttribute("data-option-selected") ||
              m.type.push("chosevalue");
            break;
          case "promocode":
            "y" !== w ||
              !f.length ||
              ...
              m.type.push("promocode");
            break;
          case "deliveryreq":
            m.type.push("deliveryreq");
        }
        c > 0 && p.length && p.length < c && m.type.push("minlength"),
          u > 0 && p.length && p.length > u && m.type.push("maxlength");
      }
    ...
    if ("y" === w) {
      ...
      if (x)
        if (window.tcart.prodamount < window.tcart_minorder)
          (m = { obj: {}, type: [] }).type.push("minorder"), r.push(m);
      if (S && window.tcart.total < window.tcart_mincntorder)
        (m = { obj: {}, type: [] }).type.push("minquantity"), r.push(m);
    }
  ...
  (window.tildaForm.showErrorInPopup = function (t, e) {
      ...
      if (e[m] && e[m].obj) {
        ...
        for (var f = 0; f < e[m].type.length; f++) {
          var _ = e[m].type[f],
            y = t_forms__getMsg(_);
          (d = ""),
            (s = t.querySelector(".js-rule-error-" + _))
              ? (s.textContent && s.innerText) || !y || -1 !== c.indexOf(y)
                ? ((d = s.textContent || s.innerText),
                  -1 === c.indexOf(y) &&
                    (c = c + '<p class="t-form__errorbox-item">' + d + "</p>"))
                : (c = c + '<p class="t-form__errorbox-item">' + y + "</p>")
              : y &&
                -1 === c.indexOf(y) &&
                (c = c + '<p class="t-form__errorbox-item">' + y + "</p>"),
            n &&
              (!d && t_forms__getMsg(_ + "field")
                ? (d = t_forms__getMsg(_ + "field"))
                : y && (d = y),
              d &&
                a &&
    ...
    if (
      ...
      var g = t.closest(".r"),
        v = "focus";
      document.addEventListener || (v = "focusin"),
        t_removeEventListener(g, v, h),
        t_addEventListener(g, v, h, !0),
        t_removeEventListener(g, "change", h),
        t_addEventListener(g, "change", h, !0);
    }
      ...
      if (e[d] && e[d].obj) {
        if (0 === d && "none" === e[d].obj) {
          ...
          for (var c = 0; c < i.length; c++)
            (i[c].innerHTML = t_forms__getMsg("emptyfill")),
              (i[c].style.display = "block");
          break;
        }
        var u = e[d].obj;
        u instanceof Element || (u = u[0]),
          u && (o = u.closest(r)),
          o &&
        ...
        for (var c = 0; c < e[d].type.length; c++) {
          var m = e[d].type[c];
          if (
            ((l = ""), (i = t.querySelectorAll(".js-rule-error-" + m)).length)
          )
            for (var p = 0; p < i.length; p++)
              i[p].getAttribute("data-rule-filled")
                ? (i[p].style.display = "block")
                : ((i[p].textContent && i[p].innerText) || !t_forms__getMsg(m)
                    ? (l = i[0].textContent || i[0].innerText)
                    : (i[p].innerHTML = t_forms__getMsg(m)),
                  (i[p].style.display = "block"));
          else if (
            t_forms__getMsg(m) &&
            (i = t.querySelectorAll(".js-rule-error-all")).length
          )
            for (var p = 0; p < i.length; p++)
              (i[p].innerHTML = t_forms__getMsg(m)),
                (i[p].style.display = "block");
          a &&
            (!l && t_forms__getMsg(m + "field")
              ? (l = t_forms__getMsg(m + "field"))
              : !l && t_forms__getMsg(m) && (l = t_forms__getMsg(m)),
            l &&
              o &&
              ((s = o.querySelectorAll(".t-input-error")),
  ...
  (window.tildaForm.send = function (form, btnSubmit, formType, formKey) {
    ...
    if (
      ...
      var formUrl = "https://" + window.tildaForm.endpoint,
        dataForm = [],
        arrFilter = [];
      if (
      ...
      var formDataObject = Object.fromEntries(allFormData);
      var agreementAdv = formDataObject.Checkbox_2 || 'no';
      var personalAdv = formDataObject.Checkbox || 'no';

      return (
        
          objSendData = {
          comment: "Company: " + formDataObject.Company + "; Потенциальное количество пользователей: " + formDataObject.UsersNum + "; Согласие на обработку персональных данных: " + personalAdv  + "; Согласие на получение рекламы: " + agreementAdv + ";",
        ...
        xhr.send(JSON.stringify(objSendData)),
        !1
      );
    }
  ...
  for (
    ...
    if (
      !(
        !r[o].name ||
        r[o].disabled ||
        ["file", "reset", "submit", "button"].indexOf(r[o].type) > -1
      )
    )
      if ("select-multiple" !== r[o].type)
        (["checkbox", "radio"].indexOf(r[o].type) > -1 && !r[o].checked) ||
