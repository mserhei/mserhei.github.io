...
function t_form_phonemask_load(e) {
  ...
  e && void 0 !== e.getAttribute) {
      ...
      t_form_phonemask_init(t, n, a)
  }
}
function t_form_phonemask_init(e, t, n) {
  if (n && "undefined" !== n)
      t_form_phonemask_initPhoneMaskForm(e, t, n);
  else if (window.geoCountry)
      ...
      a.open("GET", "https://geo.tildacdn.com/geo/country/", !0),
      a.onreadystatechange = function() {
          if (4 === a.readyState)
              if (a.status >= 200 && a.status < 400) {
                  ...
                  p.initEvent("geoCountryLoaded", !0, !1),
                  document.dispatchEvent(p),
                  t_form_phonemask_initPhoneMaskForm(e, t, n)
              } else
                  t_form_phonemask_initPhoneMaskForm(e, t, "")
      }
      ,
      a.send(),
...
function t_form_phonemask_initPhoneMaskForm(e, t, n) {
  ...
  if (a) {
      ...
      if (p || (window.tildamode && "zero" === window.tildamode ? (p = a.querySelector('.tn-artboard [data-input-lid="' + t + '"]')) || (p = a.querySelector(".tn-artboard")) : (p = document.querySelector('[data-input-lid="' + t + '"]')) || (p = document.body)),
      !p.getAttribute("data-init-mask")) {
          t_form_phonemask__replaceInput(p),
          ...
          if (o) {
              ...
              if (i[n])
                  ...
                  var r = {
                    ...
                    , n = "ru";
              o.setAttribute("data-phonemask-iso", n),
              o.setAttribute("data-phonemask-code", n.length > 0 ? r.c : ""),
              o.setAttribute("data-phonemask-mask", n.length > 0 ? r.m : ""),
              t_form_phonemask__calcMaxlength(o);
              var s = p.querySelector(".t-input-phonemask__select-flag"), m = p.querySelector(".t-input-phonemask__select-code"), c = o.getAttribute("data-phonemask-mask"), l = o.getAttribute("data-phonemask-code"), x;
              if (n.length > 0) {
                  try {
                  ...
                  s.setAttribute("data-phonemask-flag", n),
                  m.innerHTML = r.c,
                  c && o.setAttribute("placeholder", c.substr(l.length).replace(/^-+/, "")),
                  t_form_phonemask__changeMinLength(o.getAttribute("placeholder"), l, p)
              }
              t_form_phonemask__addCurrentStyle(p),
              p.querySelector(".t-input-phonemask__options-wrap").innerHTML = t_form_phonemask__getDrawSelector(i),
              t_form_phonemask__initSelectEvents(a, p, i),
              p.setAttribute("data-init-mask", "yes")
          }
      }
  }
}
...
function t_form_phonemask__addCurrentStyle(e) {
  ...
  "rgb(0, 0, 0)" !== o && (n.style.color = o),
  n.style.fontSize = i,
  n.style.fontWeight = r,
  n.style.fontFamily = s,
  p.style.fontSize = i,
  p.style.fontWeight = r
}
function t_form_phonemask__getDrawSelector(e) {
  var t = "";
  for (var n in t += "<noindex>",
  e)
      t += '<div class="t-input-phonemask__options-item" id="t-phonemask_' + n + '" data-phonemask-name="' + e[n].n + '" data-phonemask-mask="' + e[n].m + '" data-phonemask-country-code="' + n + '" data-phonemask-code="' + e[n].c + '">',
...
function t_form_phonemask__initSelectEvents(e, t, n) {
  ...
  function l() {
      if (i.classList.contains("t-input-phonemask__options-wrap_open") ? x() : (x(),
      i.classList.add("t-input-phonemask__options-wrap_open")),
      1 === a.length) {
          var n = a[0].getBoundingClientRect().height, p = t.getBoundingClientRect(), o = p.y - e.getBoundingClientRect().y, r = p.height, s;
          n < o + i.getBoundingClientRect().height + r ? (i.style.top = "auto",
          i.style.bottom = "100%") : (i.style.bottom = "auto",
          i.style.top = "100%")
      }
  }
  function x() {
  ...
  function u() {
      var e = this, n = this.value, a;
      "(" !== n && n || (this.value = "",
      t.querySelector(".js-phonemask-result").value = "",
      t.querySelector(".js-phonemask-result-iso").value = ""),
      this.setAttribute("data-phonemask-current", n),
      t_form_phonemask__addNumberMask(t_form_phonemask__copypasteHandling(this, this.getAttribute("data-phonemask-without-code")), this),
      t_form_phonemask__changeVal(t, p),
      "+7" === this.getAttribute("data-phonemask-code") && 1 === this.value.indexOf("89") && (this.value = this.value.replace("89", "9"))
  }
  function d() {
      t_form_phonemask__chooseCountry(t, this),
      t_form_phonemask__calcMaxlength(p),
      x()
  }
  function h(e) {
  ...
  function _(e) {
      ...
      if (t) {
          var a = /[-[\]/{}()*+?.\\^$|]/g
            ...
            , o = [];
          if (p && p.classList.remove("t-input-phonemask__options-item_chosen"),
          e.keyCode >= 48 && e.keyCode <= 57 || e.keyCode >= 96 && e.keyCode <= 105) {
              for (var i in s = (s += e.key).replace(a, "\\$&"),
              n)
                  t_form_phonemask__searchCountry(t, s, o, i, n[i].c);
              t_form_phonemask__scrollToCountry(t, o)
          } else if (e.keyCode >= 65 && e.keyCode <= 90 || 32 == e.keyCode) {
              for (var i in s = (s += e.key).replace(a, "\\$&"),
              n)
                  t_form_phonemask__searchCountry(t, "^" + s, o, i, n[i].n);
              t_form_phonemask__scrollToCountry(t, o)
          }
          c()
      }
  ...
  document.querySelector('[data-init-mask="yes"]') || (document.addEventListener("mouseup", h),
  document.addEventListener("keyup", _))
}
function t_form_phonemask__copypasteHandling(e, t) {
  var n = e.value
    , a = n.match(/[0-9]/g) ? n.match(/[0-9]/g) : n;
  return "object" == typeof a && a.length > t.match(/[0-9]/g).join("").length && (n = a.splice(e.getAttribute("data-phonemask-code").match(/[0-9]/g).length).join("")),
  n
}
function t_form_phonemask__addNumberMask(e, t) {
  ...
  if (i) {
      for (var s = 0; s < i.length; s++)
          "9" === i[s][0] ? (r += o.slice(0, i[s].length).join(""),
          o.splice(0, i[s].length)) : r += i[s];
      r = (r = r.replace(/[\s()-]+$/, "")).replace(/^-+/, ""),
      t.value = r
  }
}
function t_form_phonemask__changeVal(e, t) {
  t.value && (e.querySelector(".js-phonemask-result").value = t.getAttribute("data-phonemask-code") + " " + t.value,
  e.querySelector(".js-phonemask-result-iso").value = t.getAttribute("data-phonemask-code"))
}
function t_form_phonemask__chooseCountry(e, t) {
  ...
  n.setAttribute("data-phonemask-iso", r),
  n.setAttribute("data-phonemask-code", o),
  n.setAttribute("data-phonemask-mask", i);
  var m = i.substr(o.length).replace(/^-+/, "");
  n.setAttribute("placeholder", m),
  a.innerHTML = o,
  p.setAttribute("data-phonemask-flag", r);
  try {
  ...
  n.focus(),
  s && t_form_phonemask__addNumberMask(s, n),
  t_form_phonemask__changeVal(e, n),
  t_form_phonemask__changeMinLength(m, o, e)
}
function t_form_phonemask__searchCountry(e, t, n, a, p) {
  var o = new RegExp(t,"i");
  -1 !== p.search(o) && (n.push(e.querySelector("#t-phonemask_" + a)),
...
function t_form_phonemask__scrollToCountry(e, t) {
  if (0 !== t.length) {
      ...
      ))[0].getBoundingClientRect().top, p = e.getBoundingClientRect().top, o = document.body.scrollTop + e.scrollTop;
      e.scrollTop = a - p + o
  }
}
